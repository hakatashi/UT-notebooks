...
以下のPythonプログラムを使用して軌道計算を行った。\lstinputlisting[breaklines=true,captionpos=b,frame=tb,language=Python,caption={galaxyA.py}]{C:/Users/hakatashi/OneDrive/Documents/Todai/astro/final/galaxyA.py}

ここで$\mu=0.05,R_{b}\sim0.167,R_{d}=0.5$とした。

これを実行したところ、以下のような結果を得た。

\includegraphics{astro03_A}
...
\lstinputlisting[breaklines=true,captionpos=b,frame=tb,language=Python,caption={galaxyB.py}]{C:/Users/hakatashi/OneDrive/Documents/Todai/astro/final/galaxyB.py}
...
\includegraphics{astro03_B01}

\includegraphics{astro03_B02}

\includegraphics{astro03_B03}

\includegraphics{astro03_B04}
...
\lstinputlisting[breaklines=true,captionpos=b,frame=tb,language=Python,caption={galaxyC.py}]{C:/Users/hakatashi/OneDrive/Documents/Todai/astro/final/galaxyC.py}

ここで初期条件及びパラメータは課題Bと同じものとした。

これを実行したところ、以下のような経過を得た。

\includegraphics{astro03_C01}

\includegraphics{astro03_C02}

\includegraphics{astro03_C03}

\includegraphics{astro03_C04}
...
\lstinputlisting[breaklines=true,captionpos=b,frame=tb,language=Python,caption={galaxyD.py}]{C:/Users/hakatashi/OneDrive/Documents/Todai/astro/final/galaxyD.py}

ここで$\mu=0.5$とし、銀河2のその他の条件は銀河1と同じにした。これによってほぼ同程度の大きさの銀河どうしの衝突の様子がシミュレートできると考えた。またこのために銀河2のダークマターの影響も考慮するようプログラムを修正している。

これにより、以下のような経過を得た。

\includegraphics{astro03-Ex02}

\includegraphics{astro03-Ex03}

\includegraphics{astro03-Ex04}

\includegraphics{astro03-Ex05}

\includegraphics{astro03-Ex06}

\includegraphics{astro03-Ex07}

\includegraphics{astro03-Ex08}

\includegraphics{astro03-Ex09}

\includegraphics{astro03-Ex01}

銀河どうしが相互作用しきれいな模様を描くようすが観測された。

これと類似する、相互作用する銀河の観測画像を探したところ、ハッブル望遠鏡のとらえたNGC 4038-4039がこの5\textasciitilde{}6枚目と類似するようである。

\includegraphics{hs-2006-46-a-print}

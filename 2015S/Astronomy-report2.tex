...
\includegraphics{images/Astronomy-report2/SgrA}
...
\lstinputlisting[breaklines=true,captionpos=b,frame=tb,language=Python,caption={fit.py}]{images/Astronomy-report2/fit.py}
...
\verbatiminput{images/Astronomy-report2/sgrA.gnuplot}

\includegraphics{images/Astronomy-report2/S2}

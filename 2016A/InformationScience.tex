...
\item $H\left(S\right)\geq L$でなければならない
\end{enumerate}
...
例:
\begin{center}
\includegraphics{images/InformationScience/4-1}
\par\end{center}
...
2次の拡大情報源 ハフマン符号
\begin{center}
\includegraphics{images/InformationScience/4-2}
\par\end{center}
...
\paragraph{例 2値画像}
\begin{center}
\includegraphics{images/InformationScience/4-3}
\par\end{center}
...
run/length: 連なり/符号化
\begin{center}
\includegraphics{images/InformationScience/5-1}
\par\end{center}

\begin{center}
\includegraphics{images/InformationScience/5-2}
\par\end{center}

\paragraph{ランレングス+ハフマン符号化}
\begin{center}
\includegraphics{images/InformationScience/5-3}
\par\end{center}
...
``エリアス符号''
\begin{center}
\includegraphics{images/InformationScience/6-1}
\par\end{center}
...
確率を反映させた``区切り''を用いる
\begin{center}
\includegraphics{images/InformationScience/6-2}
\par\end{center}

\begin{center}
\includegraphics{images/InformationScience/6-3}
\par\end{center}
...
\begin{center}
\includegraphics{images/InformationScience/6-4}
\par\end{center}
\begin{itemize}
\item テーブルを使わない
\item 算術演算で符号を生成
...
\end{itemize}
\begin{center}
\includegraphics{images/InformationScience/6-5}
\par\end{center}
...
\item 2元対称通信路
\begin{center}
\includegraphics{images/InformationScience/6-6}
\par\end{center}
...
\item 2元対称消失通信路
\begin{center}
\includegraphics{images/InformationScience/6-7}
\par\end{center}
...
\begin{center}
\includegraphics{images/InformationScience/6-8}
\par\end{center}
...
\begin{center}
\includegraphics{images/InformationScience/6-9}
\par\end{center}

\paragraph{加法的通信路}
\begin{center}
\includegraphics{images/InformationScience/6-10}
\par\end{center}
...
\begin{center}
\includegraphics{images/InformationScience/7-1}
\par\end{center}
...
\end{enumerate}
\begin{center}
\includegraphics{images/InformationScience/7-2}
\par\end{center}

\begin{center}
\includegraphics{images/InformationScience/7-3}
\par\end{center}
\begin{itemize}
...
\paragraph{通信路符号化法}
\begin{center}
\includegraphics{images/InformationScience/7-4}
\par\end{center}
...
\paragraph{$t$重誤り訂正}
\begin{center}
\includegraphics{images/InformationScience/7-5}
\par\end{center}
\begin{itemize}
...
\begin{center}
\includegraphics{images/InformationScience/7-6}
\par\end{center}
\begin{itemize}
...
例) 単一パリティチェック
\begin{itemize}
\item 情報ビット $x_{1},x_{2},\cdots,x_{k}\left(\Rightarrow\boldsymbol{x}\right)$
\item 検査ビット(パリティビット) $c=x_{1}+x_{2}+\cdots+x_{k}$
\end{itemize}
→2元

$\left(x_{1},x_{2},\cdots,x_{k},c\right)$←単一パリティ検査符号

$(1,1,1,0)\rightarrow\left(1,1,1,0,1\right)$: 情報ビット→パリティ(検査)ビット

検査式
\[
x_{1}+x_{2}+\cdots+x_{k}+c=0
\]

受信側 $x_{i}\rightarrow y_{i}\cdots c\rightarrow y_{k+1}$

\[
y_{1}+y_{2}\cdots+y_{k}+y_{k+1}=0
\]
...
\begin{align*}
S & =\left(x_{1}+e_{1}\right)+\left(x_{2}+e_{2}\right)+\cdots+\left(c+e_{k+1}\right)\\
 & =\left(x_{1}+x_{2}+\cdots+c\right)+\left(e_{1}+e_{2}+\cdots+e_{k+1}\right)
\end{align*}

\begin{itemize}
\item 誤りが1つでも$e_{1}\sim e_{k+1}$の中にあれば、$S\neq0$となる。
\item 誤りが偶数だと$S=0$、奇数だと$S=1$→1つの誤りまで検出可能と考える
\end{itemize}

\paragraph{符号関西章距離}
\begin{center}
\includegraphics{images/InformationScience/8-1}
\par\end{center}
...
\[
\left(\underbrace{x_{1},x_{2},\cdots,x_{k}}_{\text{情報ビット}},\underbrace{c_{1},c_{2},\cdots,c_{n-k}}_{\text{検査ビット}}\right)
\]
(情報ビット,検査ビット)←組織符号

符号語$n$ビット、情報ビット$k$ビット→$\left(n,k\right)$符号

符号語 $\left(w_{1},w_{2},\cdots,w_{m}\right)\left(=\boldsymbol{w}\right)$

線形符号では、$\boldsymbol{w}_{i},\boldsymbol{w}_{j}$が符号語であれば、$\boldsymbol{w}_{i}+\boldsymbol{w}_{j}$も符号語になる。

単一パリティの例をとると、

\begin{align*}
\boldsymbol{w}_{i} & =\left(x_{1}^{i},x_{2}^{i},\cdots,c^{i}\right)\\
\boldsymbol{w}_{j} & =\left(x_{1}^{j},x_{2}^{j},\cdots,c^{j}\right)\\
\boldsymbol{w}_{i}+\boldsymbol{w}_{j} & =\left(x_{1}^{i}+x_{1}^{j},x_{2}^{i}+x_{2}^{j},\cdots,c^{i}+c^{j}\right)
\end{align*}

検査方程式

\begin{align*}
\left(x_{1}^{i}+x_{1}^{j}\right)+\cdots+\left(c^{i}+c^{j}\right) & =\left(x_{1}^{i}+\cdots+c^{i}\right)+\left(x_{1}^{j}+\cdots+c^{j}\right)\\
 & =0
\end{align*}
...
\begin{align*}
d_{\mathrm{min}} & =\min_{\boldsymbol{a},\boldsymbol{b}\in C,\boldsymbol{a}\neq\boldsymbol{b}}d_{H}\left(\boldsymbol{a},\boldsymbol{b}\right)\\
 & =\min w_{H}\left(\boldsymbol{a}-\boldsymbol{b}\right)
\end{align*}

線形符号であれば、$\boldsymbol{a}-\boldsymbol{b}$もまた$\boldsymbol{c}\in c$

\[
d_{\mathrm{min}}=\min_{\boldsymbol{c}\neq0,\boldsymbol{c}\in c}w_{H}\left(\boldsymbol{c}\right)
\]


\paragraph{ハミング符号(7,4)符号}

単一訂正符号

情報ビット $x_{1},x_{2},x_{3},x_{4}$

パリティビット $c_{1},c_{2},c_{3}$
...
符号語 $w=\left(x_{1},x_{2},x_{3},x_{4},c_{1},c_{2}c_{3}\right)\rightarrow\left(w_{1},w_{2},w_{3},w_{4},w_{5},w_{6},w_{7}\right)$

\paragraph{検査方程式}

\[
\begin{cases}
w_{1}+w_{2}+w_{3}+w_{5}=0\\
w_{2}+w_{3}+w_{4}+w_{6}=0\\
w_{1}+w_{2}+w_{4}+w_{7}=0
\end{cases}
\]

$w\Rightarrow y=\left(y_{1},y_{2},y_{3},\cdots,y_{7}\right)$ 受信語

\[
\begin{cases}
S_{1}=y_{1}+y_{2}+y_{3}+y_{5}\\
S_{2}=y_{2}+y_{3}+y_{4}+y_{6}\\
S_{3}=y_{1}+y_{2}+y_{4}+y_{7}
\end{cases}
\]

誤り$\left(e_{1},e_{2},\cdots,e_{7}\right)$とすると、
\[
\begin{cases}
S_{1}=e_{1}+e_{2}+e_{3}+e_{5}\\
S_{2}=e_{2}+e_{3}+e_{4}+e_{6}\\
S_{3}=e_{1}+e_{2}+e_{4}+e_{7}
\end{cases}
\]

\begin{center}
\includegraphics{images/InformationScience/8-2}
\par\end{center}

\paragraph{符号語間最小距離}

$d_{\mathrm{min}}=d_{\mathrm{min}}w_{H}\left(\boldsymbol{w}\right)$

ハミング(7,4) 符号の符号間最小距離→3
\begin{center}
\includegraphics{images/InformationScience/8-3}
\par\end{center}
...
\[
\left(y_{1},\cdots,y_{7}\right)\left[\begin{array}{ccc}
1 & 0 & 1\\
1 & 0 & 1\\
1 & 1 & 0\\
0 & 1 & 1\\
...
0 & 1 & 0\\
0 & 0 & 1
\end{array}\right]=\left(s_{1},s_{2}s_{3}\right)
\]

\begin{align*}
y & =\boldsymbol{w}+\boldsymbol{e}\\
\boldsymbol{s} & =\left(\boldsymbol{w}+\boldsymbol{e}\right)H^{T}\\
 & =\boldsymbol{w}H+\boldsymbol{e}H^{T}\\
 & =\boldsymbol{e}H^{T}
\end{align*}

\[
\boldsymbol{e}_{1}H^{T}\neq\boldsymbol{e}_{2}H^{T}
\]

\[
\left(\boldsymbol{e}_{1}+\boldsymbol{e}_{2}\right)H^{T}\neq0
\]

$\boldsymbol{e}_{i}$が1ゑ1つしか含まないならば、$\boldsymbol{e}_{i}+\boldsymbol{e}_{j}\left(i\neq j\right)$に対してシンドロームは0となる

1重誤りに対して$H^{T}$のいかなる2列の和も非0となる→単一誤り訂正

性質: $t$重誤りに対しては、いかなる$2t$列の和も非0となる
...
\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/InformationScience/9-1.jpg}
\par\end{center}

\paragraph{巡回符号}
\begin{itemize}
\item 線形符号の仲間
\item シフトレジスタの符号化・復号化が容易
\item 符号の巡回置換も符号

\begin{align*}
m & =\left(u_{0},u_{1},\cdots,u_{n-1}\right)\\
m' & =\left(u_{n-1},u_{0},\cdots,u_{n-2}\right)
\end{align*}

符号の多項式表現
\[
u\left(t\right)=u_{0}+u_{1}x+\cdots+u_{n-1}x^{n-1}
\]

符号多項式と呼ぶ。

\begin{align*}
xu\left(t\right) & =u_{0}x+u_{1}x^{2}+\cdots+u_{n-2}x^{n-1}+u_{n-1}x^{n}\\
 & \Rightarrow\underbrace{u_{n-1}+u_{0}x+\cdots+u_{n-2}x^{n-1}}_{u'\left(x\right)}+u_{n-1}\left(x^{n}-1\right)
\end{align*}

\[
u'\left(x\right)=xu\left(x\right)\mod\left(x^{n}-1\right)
\]
...
\[
u\left(x\right)=q\left(x\right)g\left(x\right)
\]

$q\left(x\right)$: 情報多項式

$g\left(x\right)$: 生成多項式

→後述するように、実際には\uline{割り算}でつくる。

\[
u'\left(x\right)=xu\left(x\right)+u_{n-1}\left(x^{n}-1\right)
\]

$g\left(x\right)$は$x^{n}-1$を割り切ることのできる多項式

\paragraph{例 単一パリティ検査符号}

$g\left(x\right)=x-1$ 生成多項式

$x^{n}-1$ 任意の$n$に大衆絵割り切る

\begin{align*}
u\left(x\right) & =\left(x-1\right)\left(q_{0}+q_{1}x+\cdots\right)\\
 & =u_{0}+u_{1}x+\cdots+u_{n-1}x^{n-1}
\end{align*}

\begin{align*}
u\left(1\right) & =0\\
u\left(1\right) & =u_{0}+u_{1}+\cdots+u_{n-1}=0
\end{align*}

→線形単一パリティ検査符号の検査方程式

\paragraph{例 巡回ハミング$\left(7,4\right)$符号}
\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/InformationScience/9-2.jpg}
\par\end{center}

\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/InformationScience/9-3.jpg}
\par\end{center}

\paragraph{シンドローム}

\[
y\left(x\right)=u\left(x\right)+e\left(x\right)
\]
...
\begin{align*}
y\left(x\right)\mod g\left(x\right) & =u\left(x\right)+e\left(x\right)\mod g\left(x\right)\\
 & =e\left(x\right)\mod g\left(x\right)
\end{align*}


\paragraph{巡回ハミング$\left(7,4\right)$符号について}

\[
e\left(x\right)\mod\left(x^{2}+x+1\right)
\]

\[
x^{n-k}p\left(x\right)+r\left(x\right)
\]

$g\left(x\right)$で割り切れる符号多項式

\[
\underbrace{c_{0}+c_{1}x+\cdots+c_{n-k-1}x^{n-k-1}+}_{\text{パリティビット}}\underbrace{p_{0}x^{n-k}+\cdots+p_{k}^{n-1}}_{\text{情報ビット}}
\]

\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/InformationScience/9-4.jpg}
\par\end{center}

\paragraph{割り算回路}
\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/InformationScience/9-5.jpg}
\par\end{center}

\[
x^{4}\Rightarrow\left(1,0,0,0,0\right)
\]

\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/InformationScience/9-6.jpg}
\par\end{center}

\paragraph{巡回ハミング符号$\left(7,4\right)$符号化回路}
...
\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/InformationScience/9-7.jpg}
\par\end{center}
...
\paragraph{巡回符号}
\begin{itemize}
\item 生成多項式$g\left(x\right)$で割り切れるように符号多項式
\item 符号化
\begin{itemize}
\item $q\left(x\right)=q_{0}+q_{1}x+q_{2}x^{2}+\cdots+q_{k-1}x^{k-1}$
\item ⇒$x^{n-k}$
\item ⇒$g\left(x\right)$で割り
\item ⇒余り$\gamma\left(x\right)$
\begin{align*}
g\left(x\right) & =g_{0}+g_{1}x+\cdots+g_{n-k}x^{n-k}\\
x^{n-k}q\left(x\right) & =q_{0}x^{n-k}+q_{1}x^{n-k+1}+\cdots+q_{k-1}x^{n-k}\\
\gamma\left(x\right) & =\gamma_{0}+\gamma_{1}x+\cdots+\gamma_{n-k-1}x^{n-k-1}
\end{align*}
\item ⇒
\[
u\left(x\right)=u_{0}+u_{1}x+\cdots+u_{n-1}x^{n-1}
\]
\[
\left(\underbrace{\gamma_{0},\gamma_{1},\cdots,\gamma_{n-k-1},q_{0},q_{1},\cdots,q_{k-1}}_{n\text{個}}\right)
\]
\end{itemize}
\end{itemize}
...
$q\left(x\right)=x^{3}+x+1$

(図略)

\[
x^{6}\rightarrow\left(1\quad0\quad0\right)
\]

\begin{tabular}{|c|c|c|c|c|}
\hline 
 &  & $D_{)}$  & $D_{2}$ & $D_{3}$\tabularnewline
\hline 
\hline 
...
\hline 
3 & 0 & 0 & 0 & 1\tabularnewline
\hline 
4 & 0 & 1 & 1 & 0\tabularnewline
\hline 
5 & 0 & 0 & 1 & 1\tabularnewline
\hline 
6 & 0 & 1 & 1 & 1\tabularnewline
\hline 
7 & 0 & 1 & 0 & 1\tabularnewline
\hline 
\end{tabular}

\paragraph{CDにおける誤り訂正}

音声

→44.1kHz 16ビット/サンプル\texttimes 2(ステレオ)

→6サンプル分\texttimes 2チャンネル (24byte)

→24byte→{[}CIRS符号{]}→32byte$\xrightarrow{\text{1byte補助符号(曲番号等)}}$33byte

$\xrightarrow{\text{254bit}}${[}EFM変換{]}(8to14 Moderation, 3セットのマージン)

$\xrightarrow[\text{24bit同期符号}]{\text{564bit}}${[}媒体へ記録{]}(568bit)
...
→(最小符号間距離5byte, 符号誤り訂正(2byte誤り訂正))→(28, 24)RS

→(28byte)→{[}IL{]}→22byte

→RS符号(最小符号間距離5byte)(誤り検出 3byte, (+誤り訂正 1byte))
...
\begin{itemize}
\item 1/17 1限
\item A4一枚のメモ持ち込み可 自筆に限る
\item 対数表的なものは用意するので計算機(電卓)は利用しない
\end{itemize}

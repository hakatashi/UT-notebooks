...
周期的境界条件
\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/ElectronicPhysics/3-1.jpg}
\par\end{center}
...
$C_{n}$: 複素数(時間に無依存)
\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/ElectronicPhysics/3-2.jpg}
\par\end{center}
...
\begin{center}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{images/ElectronicPhysics/3-4.jpg}
\par\end{center}
...
Sch\textbackslash{}''oredinger方程式を用いて
\[

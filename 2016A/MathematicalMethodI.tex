...
\paragraph{ベン図}
\begin{center}
\includegraphics{images/MathematicalMethodI/1-1}
\par\end{center}

\begin{center}
\includegraphics{images/MathematicalMethodI/1-2}
\par\end{center}
...
\begin{center}
\includegraphics{images/MathematicalMethodI/1-3}
\par\end{center}
...
共通部分あり
\begin{center}
\includegraphics{images/MathematicalMethodI/1-4}
\par\end{center}
...
共通部分なし: 排反事象
\begin{center}
\includegraphics{images/MathematicalMethodI/1-5}
\par\end{center}
...
\begin{center}
\includegraphics{images/MathematicalMethodI/1-6}
\par\end{center}

積事象 $A\cap B$ $A$かつ$B$ $A$と$B$が同時に起こる
\begin{center}
\includegraphics{images/MathematicalMethodI/1-7}
\par\end{center}
